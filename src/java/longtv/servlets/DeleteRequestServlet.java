...
public class DeleteRequestServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(dao.deleteRequest(orderID)) {
                url = SUCCESS;
            }
        } catch (Exception e) {
            log("ERROR at DeleteRequestServlet: " + e.getMessage());
            AccountErrorObject errorObject = new AccountErrorObject();
            errorObject.setErrorServlet("Deleting Request");
            errorObject.setErrorDetail("Can not delete your history at this moment, please try again later");
